    ...
    >
      ...
      >
        ...
        <div className="p-2 space-y-1 overflow-y-auto max-h-[calc(100vh-80px)]">
          ...
          >
            <Icon name="Users" size="sm" className="w-5 h-5" />
            <span>Subjects</span>
          </button>
          <button
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors"
          ...
          >
            <Icon name="Search" size="sm" className="w-5 h-5" />
            <span>Search</span>
          </button>
          <button
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors"
          ...
          >
            <Icon name="FileText" size="sm" className="w-5 h-5" />
            <span>Documents</span>
          </button>
          <button
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors"
          ...
          >
            <Icon name="Mail" size="sm" className="w-5 h-5" />
            <span>Emails</span>
          </button>
          <button
            className={`w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-all ${attract ? 'ring-2 ring-pink-500 shadow-lg shadow-pink-500/30 animate-pulse' : ''}`}
            onClick={() => {
              try {
          ...
          >
            <Icon name="Target" size="sm" className="w-5 h-5" />
          ...
          >
            <Icon name="Book" size="sm" className="w-5 h-5" />
          ...
          >
            <Icon name="Clock" size="sm" className="w-5 h-5" />
            <span>Timeline</span>
          </button>
          <button
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors"
          ...
          >
            <Icon name="Newspaper" size="sm" className="w-5 h-5" />
            <span>Media</span>
          </button>
          <button
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors"
          ...
          >
            <Icon name="BarChart3" size="sm" className="w-5 h-5" />
            <span>Analytics</span>
          </button>
          <button
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors"
          ...
          >
            <Icon name="Shield" size="sm" className="w-5 h-5" />
            <span>About</span>
          </button>
        </div>
      </div>
