...
function run() {
  try {
    ...
    const description =
      'Primary investigation into the financial and social connections during the critical period. Analyzing transaction patterns and flight logs.';
    ...
    `,
      ...
      .run(title, description, 'system', 'open', scope, '[]');
    ...
    const mockDocs = [
      {
        name: 'wire-transfer-001.pdf',
        desc: 'Wire transfer of $15M to Maxwell',
        date: '2004-03-15',
        type: 'financial_record',
        content: 'TRANSFER $15,000,000 USD TO GHISLAINE MAXWELL. BANK OF AMERICA.',
      },
      {
        name: 'bank-statement-2004.pdf',
        desc: 'JPMC Statement showing substantial inflow',
        date: '2004-04-01',
        type: 'financial_record',
        content: 'JPMC ACCOUNT 99887766. INFLOW: $25,000,000. SOURCE: WEXNER TRUST.',
      },
      {
        name: 'property-deed.pdf',
        desc: 'Palm Beach Property Deed',
        date: '2008-11-03',
        type: 'legal_document',
        content: 'DEED OF TRUST. PALM BEACH PROPERTY. JEFFREY EPSTEIN.',
      },
      {
        name: 'appraisal-report.pdf',
        desc: 'Property Appraisal Report',
        date: '2008-10-15',
        type: 'legal_document',
        content: 'APPRAISAL VALUE: $12,000,000.',
      },
      {
        name: 'wire-instructions.pdf',
        desc: 'Wire Instructions for Bank Leumi',
        date: '2010-06-18',
        type: 'financial_record',
        content: 'WIRE INSTRUCTIONS. BANK LEUMI. BENEFICIARY: MC2 MODELS.',
      },
      {
        name: 'account-opening.pdf',
        desc: 'Offshore Account Opening Documents',
        date: '2010-06-10',
        type: 'financial_record',
        content: 'ACCOUNT OPENING. US VIRGIN ISLANDS. LSJ LLC.',
      },
      {
        name: 'loan-agreement.pdf',
        desc: 'Loan Agreement with Cypress Trust',
        date: '2015-04-22',
        type: 'legal_document',
        content: 'LOAN AGREEMENT. CYPRESS TRUST. BORROWER: JEFFREY EPSTEIN.',
      },
      {
        name: 'flight-log-2002-09.pdf',
        desc: 'Flight Manifest Sept 2002',
        date: '2002-09-15',
        type: 'flight_log',
        content:
          'FLIGHT LOG. PILOT: DAVID RODGERS. PAX: JEFFREY EPSTEIN, BILL CLINTON, GHISLAINE MAXWELL.',
      },
      {
        name: 'flight-log-2003-05.pdf',
        desc: 'Flight Manifest May 2003',
        date: '2003-05-20',
        type: 'flight_log',
        content: 'FLIGHT LOG. PILOT: LARRY VISOSKI. PAX: JEFFREY EPSTEIN, PRINCE ANDREW.',
      },
    ];
    ...
    for (const name of keyNames) {
      const entity = db
        .prepare(
          `SELECT id, name as full_name, role as primary_role FROM entities WHERE name LIKE ? LIMIT 1`,
        )
        .get(`%${name}%`) as any;
    ...
    const transactions = [
      {
        ...
        date: '2004-03-15',
        type: 'Wire Transfer',
        desc: 'Large transfer to Maxwell',
        doc: 'wire-transfer-001.pdf',
      },
      {
        from: 'Wexner Trust',
        to: 'Jeffrey Epstein',
        ...
        date: '2004-04-01',
        type: 'Deposit',
        desc: 'Inflow from Wexner',
        doc: 'bank-statement-2004.pdf',
      },
      {
        from: 'Jeffrey Epstein',
        ...
        date: '2008-11-03',
        type: 'Purchase',
        desc: 'Property Acquisition',
        doc: 'property-deed.pdf',
      },
      {
        from: 'Jeffrey Epstein',
        to: 'MC2 Models',
        ...
        date: '2010-06-18',
        type: 'Wire Transfer',
        desc: 'Payment to agency',
        doc: 'wire-instructions.pdf',
      },
      {
        from: 'Cypress Trust',
        to: 'Jeffrey Epstein',
