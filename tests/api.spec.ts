...
test.describe('API Integration Tests', () => {
  ...
  test.describe('Investigations API', () => {
    ...
    test('POST/GET/DELETE /api/investigations - CRUD operations', async ({ request }) => {
      ...
      if (createResponse.ok()) {
        ...
        // Delete (cleanup)
        const deleteResponse = await request.delete(`${baseUrl}/api/investigations/${investigationId}`);
  ...
  test.describe('Forensic API', () => {
    test('GET /api/forensic/metrics-summary - should return forensic summary', async ({ request }) => {
