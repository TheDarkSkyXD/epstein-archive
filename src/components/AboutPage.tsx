      ...
      <section className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-8 space-y-4">
        ...
        <div className="bg-blue-900/30 border border-blue-500/30 rounded-lg p-4 mt-4">
          <p className="text-blue-200 text-sm">
            ...
            System now features hardened production security and a <a href="https://github.com/ErikVeland/epstein-archive/tree/main/docs/data-governance-standards.md" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline underline">Forensic Transparancy & Accountability Charter</a>.
          </p>
        </div>
