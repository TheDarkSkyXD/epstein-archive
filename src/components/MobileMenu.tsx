    ...
    <div className={`mobile-nav fixed inset-0 z-[60] transition-opacity duration-300 ${open ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
      ...
      >
        ...
        <div className="p-2 space-y-1 overflow-y-auto max-h-[calc(100vh-80px)]">
          ...
          <button className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-white hover:bg-slate-800 active:bg-slate-700 transition-colors" onClick={() => handleNavigation('/emails')}><Icon name="Mail" size="sm" className="w-5 h-5" /><span>Emails</span></button>
