...
export class EntityNameService {
  ...
  private static readonly COMMON_VERBS = new Set([
    'abandoned', 'about', 'according', 'across', 'actually', 'added', 'after', 'against',
    'announced', 'appeared', 'arrived', 'asked', 'became', 'before', 'began', 'behind',
    'being', 'believe', 'below', 'between', 'beyond', 'brought', 'called', 'came',
    'cannot', 'certainly', 'clearly', 'close', 'come', 'coming', 'considered', 'continued',
    'could', 'created', 'decided', 'despite', 'different', 'directly', 'discovered',
    'does', 'doing', 'done', 'down', 'during', 'ended', 'enough', 'especially',
    'even', 'eventually', 'expected', 'explained', 'felt', 'finally', 'finished',
    'first', 'followed', 'following', 'former', 'found', 'from', 'further', 'gave',
    'generally', 'getting', 'given', 'goes', 'going', 'gone', 'great', 'happened',
    'hardly', 'having', 'held', 'help', 'helped', 'helping', 'hence', 'herself',
    'higher', 'highest', 'himself', 'however', 'immediately', 'important', 'including',
    'indeed', 'instead', 'into', 'involved', 'itself', 'just', 'keep', 'kept',
    'knew', 'know', 'known', 'large', 'largely', 'last', 'later', 'latest',
    'least', 'left', 'less', 'like', 'likely', 'little', 'long', 'longer',
    'looked', 'looking', 'lost', 'made', 'mainly', 'make', 'making', 'many',
    'maybe', 'mean', 'means', 'meanwhile', 'might', 'more', 'moreover', 'most',
    'mostly', 'moved', 'much', 'must', 'myself', 'near', 'nearly', 'need',
    'needed', 'neither', 'never', 'next', 'none', 'nothing', 'nowhere',
    'obtained', 'often', 'once', 'only', 'onto', 'opened', 'other', 'others',
    'otherwise', 'ourselves', 'outside', 'over', 'particular', 'particularly',
    'past', 'perhaps', 'placed', 'possible', 'possibly', 'present', 'presented',
    'previously', 'probably', 'quite', 'rather', 'reached', 'really', 'recent',
    'recently', 'regarding', 'related', 'relatively', 'remained', 'reported',
    'required', 'resulted', 'said', 'same', 'saying', 'says', 'second',
    'seeing', 'seem', 'seemed', 'seems', 'seen', 'sent', 'several', 'should',
    'showed', 'shown', 'shows', 'significant', 'significantly', 'similar',
    'similarly', 'since', 'some', 'someone', 'something', 'sometimes', 'somewhat',
    'somewhere', 'soon', 'sought', 'spent', 'started', 'still', 'stopped',
    'such', 'suddenly', 'suggested', 'taken', 'taking', 'than', 'that',
    'their', 'theirs', 'them', 'themselves', 'then', 'there', 'therefore',
    'these', 'they', 'thing', 'things', 'think', 'third', 'this', 'those',
    'though', 'thought', 'three', 'through', 'throughout', 'thus', 'together',
    'told', 'took', 'toward', 'towards', 'tried', 'tries', 'trying',
    'turned', 'under', 'unless', 'unlike', 'until', 'upon', 'used',
    'useful', 'using', 'usually', 'various', 'very', 'wanted', 'well',
    'went', 'were', 'what', 'whatever', 'when', 'whenever', 'where', 'whereas',
    'wherever', 'whether', 'which', 'while', 'whole', 'whom', 'whose',
    'widely', 'will', 'with', 'within', 'without', 'would', 'your', 'yours',
    'yourself', 'yourselves',
    'was', 'is', 'are', 'am', 'be', 'been', 'being',
    'conducts', 'claims', 'argues', 'notes', 'states', 'suggests', 'implies',
    'mentions', 'references', 'discusses', 'describes', 'explains', 'identifies',
    'indicates', 'reveals', 'shows', 'tells', 'writes', 'reported', 'testified',
    'stated', 'noted', 'alleged', 'accused', 'charged', 'convicted', 'sentenced',
    'sued', 'filed', 'appealed', 'ruled', 'ordered', 'granted', 'denied',
    'dismissed', 'settled', 'agreed', 'negotiated', 'signed', 'authored',
    'co-authored', 'edited', 'published', 'released', 'issued', 'distributed',
    'circulated', 'broadcast', 'televised', 'streamed', 'posted', 'tweeted',
    'shared', 'liked', 'commented', 'replied', 'responded', 'answered'
  ]);
  ...
  private static readonly ADVERBS = new Set([
    'directly', 'immediately', 'quickly', 'slowly', 'carefully', 'easily', 'hardly',
    'nearly', 'really', 'simply', 'truly', 'actually', 'basically', 'certainly',
    'clearly', 'completely', 'definitely', 'especially', 'exactly', 'extremely',
    'finally', 'fully', 'generally', 'greatly', 'highly', 'largely', 'likely',
    'mainly', 'mostly', 'naturally', 'normally', 'obviously', 'particularly',
    'possibly', 'potentially', 'previously', 'primarily', 'probably', 'properly',
    'quickly', 'quite', 'rarely', 'recently', 'regularly', 'relatively', 'seriously',
    'significantly', 'similarly', 'simply', 'slightly', 'specifically', 'strongly',
    'successfully', 'suddenly', 'supposedly', 'surely', 'totally', 'typically',
    'ultimately', 'unfortunately', 'usually', 'virtually', 'widely'
  ]);
  ...
  private static readonly INFINITIVE_VERBS = new Set([
    'be', 'have', 'do', 'make', 'get', 'take', 'give', 'go', 'come', 'see',
    'know', 'think', 'want', 'use', 'find', 'tell', 'ask', 'work', 'seem',
    'feel', 'try', 'leave', 'call', 'keep', 'let', 'begin', 'help', 'show',
    ...
    'pass', 'sell', 'require', 'report', 'decide', 'pull', 'choose', 'constitute'
  ]);
  ...
  private static readonly PAST_TENSE_VERBS = new Set([
    'watched', 'finished', 'praised', 'praising', 'ended', 'started', 'began',
    'said', 'told', 'asked', 'wanted', 'needed', 'felt', 'thought', 'knew',
    'believed', 'hoped', 'tried', 'attempted', 'decided', 'chose', 'selected',
    'picked', 'named', 'called', 'titled', 'labeled', 'marked', 'noted',
    'mentioned', 'stated', 'declared', 'announced', 'proclaimed', 'revealed',
    'disclosed', 'exposed', 'showed', 'demonstrated', 'proved', 'confirmed',
    'verified', 'validated', 'established', 'determined', 'concluded', 'found',
    'discovered', 'learned', 'realized', 'understood', 'recognized',
    'acknowledged', 'admitted', 'accepted', 'agreed', 'approved', 'endorsed',
    'supported', 'backed', 'favored', 'preferred', 'liked', 'loved', 'enjoyed',
    'appreciated', 'valued', 'treasured', 'cherished', 'held', 'seeking',
    'sought', 'walking', 'going', 'coming', 'arriving', 'leaving', 'departing',
    'entering', 'exiting', 'moving', 'running', 'rushing', 'hurrying',
    'hastening', 'speeding', 'racing', 'dashing', 'sprinting', 'bolting',
    'addressed', 'contacted', 'phoned', 'emailed', 'texted', 'visited',
    'met', 'saw', 'heard', 'listened', 'spoke', 'talked', 'discussed',
    'argued', 'debated', 'agreed', 'disagreed', 'refused', 'accepted',
    'declined', 'rejected', 'denied', 'admitted', 'confessed', 'claimed'
  ]);

  // Generic nouns that shouldn't follow titles
  private static readonly GENERIC_NOUNS = new Set([
    'jet', 'court', 'government', 'operations', 'research', 'learning',
    'finance', 'history', 'biology', 'pediatrics', 'harvard', 'middle',
    'global', 'international', 'national', 'federal', 'state', 'local',
    'public', 'private', 'general', 'special', 'chief', 'senior', 'junior',
    'assistant', 'associate', 'deputy', 'vice', 'acting', 'interim',
    'emeritus', 'honorary', 'distinguished', 'visiting',
    'ads', 'allegations', 'article', 'articles', 'report', 'reports',
    'case', 'cases', 'court', 'courts', 'judge', 'judges',
    'lawyer', 'lawyers', 'attorney', 'attorneys', 'prosecutor', 'prosecutors',
    'witness', 'witnesses', 'victim', 'victims', 'plaintiff', 'plaintiffs',
    'defendant', 'defendants', 'source', 'sources', 'official', 'officials',
    'page', 'pages', 'paragraph', 'paragraphs', 'section', 'sections',
    'exhibit', 'exhibits', 'document', 'documents', 'file', 'files',
    'email', 'emails', 'message', 'messages', 'letter', 'letters',
    'memo', 'memos', 'note', 'notes', 'call', 'calls', 'meeting', 'meetings',
    'flight', 'flights', 'log', 'logs', 'record', 'records',
    'account', 'accounts', 'bank', 'banks', 'fund', 'funds',
    'money', 'cash', 'dollar', 'dollars', 'check', 'checks',
    'payment', 'payments', 'transfer', 'transfers',
    'question', 'questions', 'answer', 'answers',
    'statement', 'statements', 'testimony', 'testimonies',
    'deposition', 'depositions', 'interview', 'interviews',
    'investigation', 'investigations', 'inquiry', 'inquiries',
    'police', 'fbi', 'cia', 'nsa', 'doj', 'sec', 'irs',
    'news', 'media', 'press', 'reporter', 'reporters', 'journalist', 'journalists',
    'client', 'clients', 'mail', 'information', 'info', 'subject', 're', 'fw', 'fwd',
    'privileged', 'confidential', 'secret', 'top', 'classification',
    'rights', 'reserved', 'copyright', 'guid', 'uuid', 'id', 'all', 'no', 'any', 'some',
    'yes', 'com', 'time', 'date', 'year', 'month', 'day',
    // Location names that are commonly extracted as entities
    'york', 'florida', 'california', 'texas', 'washington', 'london', 'paris',
    'moscow', 'beijing', 'tokyo', 'berlin', 'rome', 'madrid', 'vienna',
    'manhattan', 'brooklyn', 'queens', 'bronx', 'chicago', 'boston', 'miami',
    'angeles', 'francisco', 'seattle', 'atlanta', 'houston', 'dallas',
    // Government/institutional terms
    'house', 'senate', 'congress', 'parliament', 'committee', 'commission',
    'oversight', 'judiciary', 'intelligence', 'armed', 'services', 'foreign',
    'relations', 'appropriations', 'budget', 'ways', 'means',
    // Common organizational terms
    'foundation', 'institute', 'center', 'centre', 'society', 'association',
    'organization', 'organisation', 'corporation', 'company', 'group', 'team',
    'department', 'division', 'bureau', 'agency', 'office', 'administration',
    // Document/legal artifacts
    'supra', 'infra', 'ibid', 'id', 'cf', 'see', 'note', 'notes', 'footnote',
    'endnote', 'appendix', 'exhibit', 'attachment', 'annex', 'schedule',
    'endstream', 'endobj', 'obj', 'stream', 'xref', 'trailer', 'startxref',
    'http', 'https', 'www', 'pdf', 'doc', 'docx', 'txt', 'html', 'xml',
    'available', 'retrieved', 'accessed', 'downloaded', 'uploaded', 'posted',
    // Relationship/connection terms
    'friendship', 'relationship', 'connection', 'association', 'partnership',
    'collaboration', 'alliance', 'affiliation', 'ties', 'links', 'bonds',
    // Test/placeholder data
    'test', 'example', 'sample', 'placeholder', 'dummy', 'mock', 'fake',
    'nt', 'na', 'n/a', 'tbd', 'tba', 'unknown', 'unnamed', 'anonymous'
  ]);

  // Titles that should only appear with proper names
  private static readonly TITLES = new Set([
    'president', 'senator', 'governor', 'professor', 'prince', 'princess',
    'king', 'queen', 'duke', 'duchess', 'lord', 'lady', 'sir', 'dr',
    'mr', 'mrs', 'ms', 'miss'
  ]);

  // Known person name variants that should be consolidated
  private static readonly NAME_VARIANTS: { [key: string]: string[] } = {
    'Donald Trump': ['Trump', 'DT', 'DJT', 'Donnie', 'Donald', 'President Trump', 'The President'],
    'Jeffrey Epstein': ['Epstein', 'Jeffrey', 'Jeff', 'J. Epstein'],
    'Bill Clinton': ['Clinton', 'President Clinton', 'William Clinton', 'Bill'],
    'Hillary Clinton': ['Hillary', 'Secretary Clinton', 'HRC'],
    'Alan Dershowitz': ['Dershowitz', 'Professor Dershowitz', 'Alan'],
    'Ghislaine Maxwell': ['Maxwell', 'Ghislaine', 'G. Maxwell'],
    'Prince Andrew': ['Prince Andrew', 'Andrew', 'Duke of York', 'The Duke'],
    'Bill Gates': ['Gates', 'William Gates'],
    'Jeff Bezos': ['Bezos', 'Jeffrey Bezos'],
    'Elon Musk': ['Musk', 'Elon'],
    'Mark Zuckerberg': ['Zuckerberg', 'Mark'],
    'Tim Cook': ['Cook', 'Timothy Cook'],
    'Satya Nadella': ['Nadella', 'Satya'],
    'Sergey Brin': ['Brin', 'Sergey'],
    'Larry Page': ['Page', 'Lawrence Page'],
    'Steve Jobs': ['Jobs', 'Steven Jobs'],
    'Warren Buffett': ['Buffett', 'Warren'],
    'Charlie Munger': ['Munger', 'Charles Munger'],
    'Michael Bloomberg': ['Bloomberg', 'Mike Bloomberg'],
    'Jamie Dimon': ['Dimon', 'James Dimon'],
    'Lloyd Blankfein': ['Blankfein', 'Lloyd'],
    'Ken Griffin': ['Griffin', 'Kenneth Griffin'],
  ...
  private static readonly ORGANIZATION_NAMES = [
    'Russia', 'Russian Federation', 'Kremlin',
  ...
  static isValidPersonName(name: string): boolean {
    ...
    if (this.PREPOSITIONS.has(lastWord) || 
    ...
    const commonPhrases = [
      'thank you', 'if you', 'please', 'sorry', 'excuse me',
      'hello', 'goodbye', 'yes sir', 'no sir', 'dear sir'
    ];
    ...
    const reportingVerbs = new Set([
      'expressed', 'stated', 'said', 'told', 'asked', 'replied',
      'responded', 'answered', 'explained', 'described', 'mentioned',
      'noted', 'observed', 'remarked', 'commented', 'testified'
    ]);
    ...
    for (let i = 0; i < lowerWords.length - 1; i++) {
      if (this.PREPOSITIONS.has(lowerWords[i])) {
        ...
        if (['the', 'a', 'an', 'this', 'that', 'these', 'those', 'his', 'her', 'their', 'our', 'my', 'your', 'its'].includes(nextWord)) {
          return false;
        }
      }
    }
    ...
    if (words.length >= 3) {
      ...
      for (const word of lowerWords) {
        if (this.GENERIC_NOUNS.has(word) || 
