...
import { articleRepository } from '../db/articleRepository.js';
...
import { bulkOperationsRepository } from '../db/bulkOperationsRepository.js';
  ...
  private initializeDatabase(): void {
    ...
    if (!ftsTableNames.includes('entities_fts') || !ftsTableNames.includes('documents_fts')) {
      try {
        ...
        console.log('FTS tables may already exist, continuing...', e);
      }
    }
    ...
    try {
      ...
      console.log('Evidence FTS table may already exist, continuing...', e);
    }
