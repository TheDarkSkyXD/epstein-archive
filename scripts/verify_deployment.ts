...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  entities: [
    'id', 'full_name', 'entity_type', 'primary_role', 
    'mentions', 'red_flag_rating', 'red_flag_score', 'created_at'
  ],
  documents: [
    'id', 'file_name', 'file_path', 'file_type', 'content',
    'red_flag_rating', 'evidence_type', 'created_at'
  ],
  entity_relationships: [
