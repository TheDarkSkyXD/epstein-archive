...
export const PersonCardRefined: React.FC<PersonCardProps> = ({ 
    ...
    try {
      ...
      if (terms.length === 0) {
        ...
        if (term.trim().length > 0) {
           ...
           return text.replace(regex, '<mark class="bg-yellow-500/30 text-white px-1 rounded">$1</mark>');
        }
        return text;
      }
  ...
  return (
    <BaseCard onClick={onClick} className="group hover:ring-1 hover:ring-blue-500/50 transition-all duration-300">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="min-w-0">
            ...
            {person?.blackBookEntry && (
              <div className="flex items-center gap-1 mt-1 text-purple-400 text-xs" title="This person appears in the Black Book">
