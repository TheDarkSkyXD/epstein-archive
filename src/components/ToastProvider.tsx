...
type Toast = { id: string, text: string, type?: 'info' | 'success' | 'error' | 'warning' | 'loading', action?: { label: string, onClick: () => void } }
...
export default function ToastProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => { if (toasts.length > 6) setToasts(prev => prev.slice(-6)) }, [toasts])
