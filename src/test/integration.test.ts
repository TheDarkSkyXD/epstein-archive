...
async function runIntegrationTest() {
  ...
  try {
    ...
    console.log(`  ✓ Stats endpoint: ${statsData.totalEntities} entities, ${statsData.totalDocuments} documents`);
  ...
  if (allRequirementsMet) {
    ...
    console.log('The Epstein Archive application is fully functional with all requirements implemented.');
  } else {
